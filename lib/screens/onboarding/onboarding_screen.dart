...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<OnboardingData> _pages = [
    OnboardingData(
      ...
      description: 'Connect your GitHub and let our AI mentor understand your unique developer journey.',
      icon: Icons.hub_outlined,
    ),
    OnboardingData(
      title: 'Follow your roadmap',
      description: 'Receive a motivational path tailored to your skills and career aspirations.',
      icon: Icons.route_outlined,
    ),
    OnboardingData(
      title: 'Level up your stack',
      description: 'Discover repositories and open-source projects that will challenge and inspire you.',
          ...
          child: Column(
            children: [
              ...
              child: TextButton(
                ...
                child: Text('SKIP', style: GoogleFonts.jetBrainsMono(color: AppTheme.textSecondary, fontSize: 12)),
              ),
            ),
            Expanded(
