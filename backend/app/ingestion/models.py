...
class NormalizedItem(BaseModel):
    ...
    source: str = Field(..., description="Source identifier (e.g., 'github', 'producthunt')")
    type: str = Field(..., description="Type of content (e.g., 'repository', 'article', 'release')")
    ...
    tags: List[str] = Field(default_factory=list, description="Associated tags or keywords")
